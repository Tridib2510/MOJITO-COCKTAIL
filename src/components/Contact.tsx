...
const Contact = () => {
    useGSAP(()=>{
        ...
        .to('#f-left-leaf',{
            ...
            duration:1,
            ease:'power1.inOut',
        },'<') //'<'-->means that the element with id f-right-leaf move 50px at the same time the element with id f-left-leaf moves down by 50px that is they move together
  ...
  return (
    ...
    <div className="content">
        ...
        <div>
            <h3>Visit Our Bar</h3>
        <p>457, Rag Blvd. #404, Los Angeles, CA 90210</p>
        </div>
        <div>
            <h3>Contact Us</h3>
           <p>(555) 987-6543</p>
